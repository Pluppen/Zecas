...
import { updateFinding, type Finding } from "@/lib/api/findings";
...
export default function EditFindingDialog ({findings, setFindings, finding, button}: {findings: any, setFindings: Dispatch<SetStateAction<Finding[]>>, finding: any, button: any}) {
